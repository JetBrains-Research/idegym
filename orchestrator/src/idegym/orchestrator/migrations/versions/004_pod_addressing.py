"""Add pod_ip, container_port and pod_manifest to servers

Sandboxes run as plain Pods addressed by IP on the container port; the manifest
is kept so a restart can recreate the pod.
