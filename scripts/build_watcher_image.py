...
def build(
    ...
    tags = [f"{registry}/watcher:{version}" for version in versions]
...
if __name__ == "__main__":
    parser = ArgumentParser(
        prog="build-watcher-image",
        description="Build IdeGYM watcher image",
    ...
    parser.add_argument(
        ...
        default=from_root("watcher", "Dockerfile"),
        type=Path,
    )
    parser.add_argument(
        "-r",
