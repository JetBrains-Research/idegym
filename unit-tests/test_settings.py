...
HYDRA_DEFAULTS: dict[str, Any] = {
    ...
    "orchestrator.build.allowed_registry_prefixes": [],
    "orchestrator.build.backend": "kaniko",
    "orchestrator.build.cloudbuild_gke.allowed_machine_types": [],
    "orchestrator.build.cloudbuild_gke.disk_size_gb": None,
    "orchestrator.build.cloudbuild_gke.machine_type": None,
    "orchestrator.build.cloudbuild_gke.max_disk_size_gb": 1000,
    ...
    "orchestrator.build.max_timeout_seconds": 7200,
...
ENVIRONMENT_VARIABLES: dict[str, list[str]] = {
    ...
    "orchestrator.build.allowed_registry_prefixes": ["IDEGYM_BUILD_ALLOWED_REGISTRY_PREFIXES"],
    "orchestrator.build.backend": ["IDEGYM_BUILD_BACKEND"],
    "orchestrator.build.cloudbuild_gke.allowed_machine_types": ["IDEGYM_CLOUDBUILD_ALLOWED_MACHINE_TYPES"],
    ...
    "orchestrator.build.cloudbuild_gke.max_disk_size_gb": ["IDEGYM_CLOUDBUILD_MAX_DISK_SIZE_GB"],
    ...
    "orchestrator.build.max_timeout_seconds": ["IDEGYM_BUILD_MAX_TIMEOUT_SECONDS"],
