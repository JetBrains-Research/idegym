...
class TestWatcherImage(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.watcher = cls.client.run(
            ...
            networks=[cls.network],
            envs={
                "IDEGYM_DATABASE_HOST": "idegym-watcher-it-pg",
                "IDEGYM_DATABASE_PORT": "5432",
                "IDEGYM_DATABASE_DB": _PG_DB,
                "IDEGYM_DATABASE_USER": _PG_USER,
                "IDEGYM_DATABASE_PASSWORD": _PG_PASSWORD,
